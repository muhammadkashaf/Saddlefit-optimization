...
function InViewItem({ elem, index }) {
  ...
  return (
    ...
    >
      ...
      <p
        className={`saddlefit_work_text ${
          index === 0 && "h-[60px] sm:h-[120px]"
        } `}
      >
        {elem?.title}
      </p>
  ...
  return (
    <div className="saddlefit_work_backgroundImage relative">
      ...
      <div className="w-full relative z-10">
        ...
        >
          <span className="saddlefit_work">How Does</span>
          <span className="work">Saddlefit Work</span>
          <span className="saddlefit_work">?</span>
        </motion.div>
